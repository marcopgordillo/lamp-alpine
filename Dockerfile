...
RUN apk update && \
      apk upgrade && \ 
      apk add --update apache2 ca-certificates openssl php7 php7-apache2 php7-curl php7-dom php7-exif php7-fileinfo php7-pecl-apcu php7-json php7-mbstring php7-mysqli php7-pdo_mysql php7-common php7-openssl php7-imagick php7-xml php7-zip php7-gd php7-iconv php7-mcrypt php7-simplexml php7-xmlreader php7-zlib php7-ssh2 php7-ftp php7-sockets php7-bcmath php7-opcache php7-phar php7-ctype php7-pdo php7-tokenizer php7-xmlwriter php7-session ghostscript imagemagick && \
      rm -rf /var/cache/apk/* && \
